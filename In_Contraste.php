...
<div class="lBar">
    <div class="lBarResponse row mx-auto mb-1 btn-color">
        <form action="PHP/formController.php" method="post">
            ...
            <button class="btn <?=$boolContraste == "true" ? "btn-outline-light" : "btn-outline-dark" ;?> col-md-10 p-0" type="submit" tabindex="7">
                <p id="contraste"><?=$boolContraste == "false" ? "Ativar Contraste" : "Desativar Contraste" ;?></p>
    ...
    <div class="lBarResponse row mx-auto btn-color">
        <button class="btn <?=$boolContraste == "true" ? "btn-outline-light" : "btn-outline-dark" ;?> col-md-10 p-0" type="button" onclick="expandeLink();" tabindex="8">
